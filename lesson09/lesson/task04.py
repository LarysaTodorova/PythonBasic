...
#    полученный балл на экзамене. Вызовите
#    функцию несколько раз, передав ей различные аргументы,
#    и выведите результаты в консоль.

def is_exam_passed(is_first_test_passed, is_second_test_passed, exam_rate):
...
result = is_exam_passed(first_test, second_test, rate)
print("Exam is passed: " , result)